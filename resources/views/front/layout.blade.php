            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                @if($totalCartItem>0)
                  ...
                  @endphp
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="{{asset('storage/media/'.$list->image)}}" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="javascript:void(0)">{{$list->name}}</a></h4>
                        <p>{{$list->qty}} * {{$list->price}} </p>
                      </div>
              ...
              <div class="aa-search-box">
                <form action="">
                  <input type="text" name="search_str" id="search_str" placeholder="Search here ex. 'man' ">
