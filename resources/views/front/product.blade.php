                    ...
                    <div id="demo-1" class="simpleLens-gallery-container">
                      ...
                      <div class="simpleLens-thumbnails-container">
                          @if(isset($product_images[$product[0]->id][0]))
                            ...
                            <a data-big-image="{{asset('storage/media/'.$list->images)}}" data-lens-image="{{asset('storage/media/'.$product[0]->image)}}" class="simpleLens-thumbnail-wrapper" href="#">
                 ...
                 @if(isset($product_review[0]))
                  ...
                  @endforeach
                   ...
                   @else
                        <h2>No Review</h2>
                  @endif
                   <form action="" id="frmProductReview" class="aa-review-form">
                      <h4>Add a review</h4>
                      <div class="aa-your-rating">
                        ...
                        <select class="form-control" name="rating" required>
                          ...
                          <option value="fnatastic">Fantastic</option>
                        </select>
